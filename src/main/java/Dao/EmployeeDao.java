...
public class EmployeeDao {
	...
	public int saveEmployee( Employee e) {
		...
		String query="insert into Employee.emp(empName,empEmail,empPass) values(?,?,?)";
		try {
			//bridge establish
	...
	public List<Employee> getAllEmployee(){
		...
		Connection con=DbConnection.getConn();
		String query="SELECT empId,empName,empEmail,empPass FROM employee.emp";
		try {
			PreparedStatement ps=con.prepareStatement(query);
	...
	public Employee fatchEmpById(int empId) {
